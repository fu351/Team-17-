...
//Metric 1
function calculate_bus_factor(contributor_commits, total_contributors) {
    return __awaiter(this, void 0, void 0, function () {
        var key_contributor, max, min, i, midrange, i;
...
//Net_Score
function calculate_net_score(contributor_commits, total_contributors, lines_of_code, num_issues, lines_of_readme, license_type, days_since_last_commit, npmPackageUrl) {
    return __awaiter(this, void 0, void 0, function () {
        var bus_factor, correctness, ramp_up_time, license, responsiveness, net_score, ndjsonEntry, ndjsonOutput;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, calculate_bus_factor(contributor_commits, total_contributors)];
                case 1:
                    bus_factor = _a.sent();
