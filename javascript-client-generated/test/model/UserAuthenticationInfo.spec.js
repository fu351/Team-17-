...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UserAuthenticationInfo', function() {
      beforeEach(function() {
        instance = new Ece461Fall2023ProjectPhase2.UserAuthenticationInfo();
      });

      it('should create an instance of UserAuthenticationInfo', function() {
        // TODO: update the code to test UserAuthenticationInfo
        expect(instance).to.be.a(Ece461Fall2023ProjectPhase2.UserAuthenticationInfo);
      });
