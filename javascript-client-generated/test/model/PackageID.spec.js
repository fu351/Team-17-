...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PackageID', function() {
      beforeEach(function() {
        instance = new Ece461Fall2023ProjectPhase2.PackageID();
      });

      it('should create an instance of PackageID', function() {
        // TODO: update the code to test PackageID
        expect(instance).to.be.a(Ece461Fall2023ProjectPhase2.PackageID);
      });
