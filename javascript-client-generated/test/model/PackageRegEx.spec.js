...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PackageRegEx', function() {
      beforeEach(function() {
        instance = new Ece461Fall2023ProjectPhase2.PackageRegEx();
      });

      it('should create an instance of PackageRegEx', function() {
        // TODO: update the code to test PackageRegEx
        expect(instance).to.be.a(Ece461Fall2023ProjectPhase2.PackageRegEx);
      });
