...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SemverRange', function() {
      beforeEach(function() {
        instance = new Ece461Fall2023ProjectPhase2.SemverRange();
      });

      it('should create an instance of SemverRange', function() {
        // TODO: update the code to test SemverRange
        expect(instance).to.be.a(Ece461Fall2023ProjectPhase2.SemverRange);
      });
