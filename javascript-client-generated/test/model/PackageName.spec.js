...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PackageName', function() {
      beforeEach(function() {
        instance = new Ece461Fall2023ProjectPhase2.PackageName();
      });

      it('should create an instance of PackageName', function() {
        // TODO: update the code to test PackageName
        expect(instance).to.be.a(Ece461Fall2023ProjectPhase2.PackageName);
      });
