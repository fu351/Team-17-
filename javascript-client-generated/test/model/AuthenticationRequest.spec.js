...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AuthenticationRequest', function() {
      beforeEach(function() {
        instance = new Ece461Fall2023ProjectPhase2.AuthenticationRequest();
      });

      it('should create an instance of AuthenticationRequest', function() {
        // TODO: update the code to test AuthenticationRequest
        expect(instance).to.be.a(Ece461Fall2023ProjectPhase2.AuthenticationRequest);
      });
